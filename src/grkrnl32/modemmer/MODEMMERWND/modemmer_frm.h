...
#ifndef modemmer_frmH
#define modemmer_frmH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
void        __fastcall monitor_string(UnicodeString & s,DWORD color = -1);
...
void __fastcall monitor_otd_medium_alarm_archive  (TModemmerMonitor * monitor, LPBYTE data, DWORD data_size);
