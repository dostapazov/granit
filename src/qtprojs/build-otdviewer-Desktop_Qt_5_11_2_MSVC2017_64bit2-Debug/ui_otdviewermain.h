...
public:
    ...
    void setupUi(QMainWindow *OtdViewerMain)
    {
        ...
        sizePolicy.setHeightForWidth(otd_addr->sizePolicy().hasHeightForWidth());
        otd_addr->setSizePolicy(sizePolicy);
        ...
        layoutWidget->setGeometry(QRect(2, 3, 138, 100));
        ...
        layoutWidget1->setGeometry(QRect(10, 0, 335, 91));
        ...
        layoutWidget2->setGeometry(QRect(0, 1, 131, 91));
