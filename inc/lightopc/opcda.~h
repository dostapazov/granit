...
extern const LPCWSTR OPC_CATEGORY_DESCRIPTION_DA10;
extern const LPCWSTR OPC_CATEGORY_DESCRIPTION_DA20;
extern const LPCWSTR OPC_CATEGORY_DESCRIPTION_DA30;
extern const LPCWSTR OPC_CATEGORY_DESCRIPTION_XMLDA10;
extern const DWORD OPC_READABLE;
extern const DWORD OPC_WRITEABLE;
extern const DWORD OPC_BROWSE_HASCHILDREN;
extern const DWORD OPC_BROWSE_ISITEM;
extern const LPCWSTR OPC_TYPE_SYSTEM_OPCBINARY;
extern const LPCWSTR OPC_TYPE_SYSTEM_XMLSCHEMA;
extern const LPCWSTR OPC_CONSISTENCY_WINDOW_UNKNOWN;
extern const LPCWSTR OPC_CONSISTENCY_WINDOW_NOT_CONSISTENT;
extern const LPCWSTR OPC_WRITE_BEHAVIOR_BEST_EFFORT;
extern const LPCWSTR OPC_WRITE_BEHAVIOR_ALL_OR_NOTHING;
...
extern const WORD OPC_QUALITY_MASK;
extern const WORD OPC_STATUS_MASK;
extern const WORD OPC_LIMIT_MASK;
extern const WORD OPC_QUALITY_BAD;
extern const WORD OPC_QUALITY_UNCERTAIN;
extern const WORD OPC_QUALITY_GOOD;
extern const WORD OPC_QUALITY_CONFIG_ERROR;
extern const WORD OPC_QUALITY_NOT_CONNECTED;
extern const WORD OPC_QUALITY_DEVICE_FAILURE;
extern const WORD OPC_QUALITY_SENSOR_FAILURE;
extern const WORD OPC_QUALITY_LAST_KNOWN;
extern const WORD OPC_QUALITY_COMM_FAILURE;
extern const WORD OPC_QUALITY_OUT_OF_SERVICE;
extern const WORD OPC_QUALITY_WAITING_FOR_INITIAL_DATA;
extern const WORD OPC_QUALITY_LAST_USABLE;
extern const WORD OPC_QUALITY_SENSOR_CAL;
extern const WORD OPC_QUALITY_EGU_EXCEEDED;
extern const WORD OPC_QUALITY_SUB_NORMAL;
extern const WORD OPC_QUALITY_LOCAL_OVERRIDE;
extern const WORD OPC_LIMIT_OK;
extern const WORD OPC_LIMIT_LOW;
extern const WORD OPC_LIMIT_HIGH;
extern const WORD OPC_LIMIT_CONST;
...
extern const DWORD OPC_PROPERTY_DATATYPE;
extern const DWORD OPC_PROPERTY_VALUE;
extern const DWORD OPC_PROPERTY_QUALITY;
extern const DWORD OPC_PROPERTY_TIMESTAMP;
extern const DWORD OPC_PROPERTY_ACCESS_RIGHTS;
extern const DWORD OPC_PROPERTY_SCAN_RATE;
extern const DWORD OPC_PROPERTY_EU_TYPE;
extern const DWORD OPC_PROPERTY_EU_INFO;
extern const DWORD OPC_PROPERTY_EU_UNITS;
extern const DWORD OPC_PROPERTY_DESCRIPTION;
extern const DWORD OPC_PROPERTY_HIGH_EU;
extern const DWORD OPC_PROPERTY_LOW_EU;
extern const DWORD OPC_PROPERTY_HIGH_IR;
extern const DWORD OPC_PROPERTY_LOW_IR;
extern const DWORD OPC_PROPERTY_CLOSE_LABEL;
extern const DWORD OPC_PROPERTY_OPEN_LABEL;
extern const DWORD OPC_PROPERTY_TIMEZONE;
extern const DWORD OPC_PROPERTY_CONDITION_STATUS;
extern const DWORD OPC_PROPERTY_ALARM_QUICK_HELP;
extern const DWORD OPC_PROPERTY_ALARM_AREA_LIST;
extern const DWORD OPC_PROPERTY_PRIMARY_ALARM_AREA;
extern const DWORD OPC_PROPERTY_CONDITION_LOGIC;
extern const DWORD OPC_PROPERTY_LIMIT_EXCEEDED;
extern const DWORD OPC_PROPERTY_DEADBAND;
extern const DWORD OPC_PROPERTY_HIHI_LIMIT;
extern const DWORD OPC_PROPERTY_HI_LIMIT;
extern const DWORD OPC_PROPERTY_LO_LIMIT;
extern const DWORD OPC_PROPERTY_LOLO_LIMIT;
extern const DWORD OPC_PROPERTY_CHANGE_RATE_LIMIT;
extern const DWORD OPC_PROPERTY_DEVIATION_LIMIT;
extern const DWORD OPC_PROPERTY_SOUND_FILE;
extern const DWORD OPC_PROPERTY_TYPE_SYSTEM_ID;
extern const DWORD OPC_PROPERTY_DICTIONARY_ID;
extern const DWORD OPC_PROPERTY_TYPE_ID;
extern const DWORD OPC_PROPERTY_DICTIONARY;
extern const DWORD OPC_PROPERTY_TYPE_DESCRIPTION;
extern const DWORD OPC_PROPERTY_CONSISTENCY_WINDOW;
extern const DWORD OPC_PROPERTY_WRITE_BEHAVIOR;
extern const DWORD OPC_PROPERTY_UNCONVERTED_ITEM_ID;
extern const DWORD OPC_PROPERTY_UNFILTERED_ITEM_ID;
extern const DWORD OPC_PROPERTY_DATA_FILTER_VALUE;
extern const LPCWSTR OPC_PROPERTY_DESC_DATATYPE;
extern const LPCWSTR OPC_PROPERTY_DESC_VALUE;
extern const LPCWSTR OPC_PROPERTY_DESC_QUALITY;
extern const LPCWSTR OPC_PROPERTY_DESC_TIMESTAMP;
extern const LPCWSTR OPC_PROPERTY_DESC_ACCESS_RIGHTS;
extern const LPCWSTR OPC_PROPERTY_DESC_SCAN_RATE;
extern const LPCWSTR OPC_PROPERTY_DESC_EU_TYPE;
extern const LPCWSTR OPC_PROPERTY_DESC_EU_INFO;
extern const LPCWSTR OPC_PROPERTY_DESC_EU_UNITS;
extern const LPCWSTR OPC_PROPERTY_DESC_DESCRIPTION;
extern const LPCWSTR OPC_PROPERTY_DESC_HIGH_EU;
extern const LPCWSTR OPC_PROPERTY_DESC_LOW_EU;
extern const LPCWSTR OPC_PROPERTY_DESC_HIGH_IR;
extern const LPCWSTR OPC_PROPERTY_DESC_LOW_IR;
extern const LPCWSTR OPC_PROPERTY_DESC_CLOSE_LABEL;
extern const LPCWSTR OPC_PROPERTY_DESC_OPEN_LABEL;
extern const LPCWSTR OPC_PROPERTY_DESC_TIMEZONE;
extern const LPCWSTR OPC_PROPERTY_DESC_CONDITION_STATUS;
extern const LPCWSTR OPC_PROPERTY_DESC_ALARM_QUICK_HELP;
extern const LPCWSTR OPC_PROPERTY_DESC_ALARM_AREA_LIST;
extern const LPCWSTR OPC_PROPERTY_DESC_PRIMARY_ALARM_AREA;
extern const LPCWSTR OPC_PROPERTY_DESC_CONDITION_LOGIC;
extern const LPCWSTR OPC_PROPERTY_DESC_LIMIT_EXCEEDED;
extern const LPCWSTR OPC_PROPERTY_DESC_DEADBAND;
extern const LPCWSTR OPC_PROPERTY_DESC_HIHI_LIMIT;
extern const LPCWSTR OPC_PROPERTY_DESC_HI_LIMIT;
extern const LPCWSTR OPC_PROPERTY_DESC_LO_LIMIT;
extern const LPCWSTR OPC_PROPERTY_DESC_LOLO_LIMIT;
extern const LPCWSTR OPC_PROPERTY_DESC_CHANGE_RATE_LIMIT;
extern const LPCWSTR OPC_PROPERTY_DESC_DEVIATION_LIMIT;
extern const LPCWSTR OPC_PROPERTY_DESC_SOUND_FILE;
extern const LPCWSTR OPC_PROPERTY_DESC_TYPE_SYSTEM_ID;
extern const LPCWSTR OPC_PROPERTY_DESC_DICTIONARY_ID;
extern const LPCWSTR OPC_PROPERTY_DESC_TYPE_ID;
extern const LPCWSTR OPC_PROPERTY_DESC_DICTIONARY;
extern const LPCWSTR OPC_PROPERTY_DESC_TYPE_DESCRIPTION;
extern const LPCWSTR OPC_PROPERTY_DESC_CONSISTENCY_WINDOW;
extern const LPCWSTR OPC_PROPERTY_DESC_WRITE_BEHAVIOR;
extern const LPCWSTR OPC_PROPERTY_DESC_UNCONVERTED_ITEM_ID;
extern const LPCWSTR OPC_PROPERTY_DESC_UNFILTERED_ITEM_ID;
extern const LPCWSTR OPC_PROPERTY_DESC_DATA_FILTER_VALUE;
