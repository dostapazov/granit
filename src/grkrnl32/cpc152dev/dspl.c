...
p_dspl_dft 					dspl_dft 			;
p_dspl_ellip_acd_cmplx				dspl_ellip_acd_cmplx		;
p_dspl_ellip_asn_cmplx				dspl_ellip_asn_cmplx		;
...
int	dspl_load()
{
	HINSTANCE hDSPL;
	LPCSTR	func_name;
	hDSPL = LoadLibrary(TEXT("dspl32.dll"));
	if(!hDSPL)
	{
		return NULL;
	}
	...
	func_name = "_dspl_ellip_acd_cmplx";
	dspl_ellip_acd_cmplx = (p_dspl_ellip_acd_cmplx) GetProcAddress(hDSPL, func_name);
	if(!dspl_ellip_acd_cmplx)
		goto error_proc;


	func_name = "_dspl_ellip_asn_cmplx";
	dspl_ellip_asn_cmplx = (p_dspl_ellip_asn_cmplx) GetProcAddress(hDSPL, func_name);
	if(!dspl_ellip_asn_cmplx)
		goto error_proc;


	func_name = "_dspl_ellip_cd_cmplx";
	dspl_ellip_cd_cmplx = (p_dspl_ellip_cd_cmplx) GetProcAddress(hDSPL, func_name);
	if(!dspl_ellip_cd_cmplx)
		goto error_proc;


	func_name = "_dspl_ellip_sn_cmplx";
	dspl_ellip_sn_cmplx = (p_dspl_ellip_sn_cmplx) GetProcAddress(hDSPL, func_name);
	if(!dspl_ellip_sn_cmplx)
		goto error_proc;


	func_name = "_dspl_ellipk";
