...
db_monitor    monitor;
        DWORD Fapply_mask;
void        __fastcall monitor_handler(DWORD code,char * text);
...
int         __fastcall get_tlmmodule_rctext(lpotd_addr adr, int type,char * name,int bsz);
...
AnsiString  __fastcall get_pdiag_text (DWORD value,bool prn_val = true);
AnsiString  __fastcall get_state_text (DWORD value,bool prn_val = true);
AnsiString  __fastcall get_diag_text  (DWORD diag,bool prn_val= true);
AnsiString  __fastcall get_part_diag_text(DWORD value,bool prn_val= true);
